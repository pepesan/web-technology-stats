...
def generate_sites(num, criterio):
    sitios = SiteSpain.objects.order_by('last_search_datetime')[:num](batch=BATCH, finished=True, tech__exists=True, __raw__=criterio['query'])
    tecnologias = dict()
